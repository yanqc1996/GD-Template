            ...
            <el-tabs v-model="activeName">
                <el-tab-pane label="用户名登录" name="用户名登录">
                    <el-form :model="ruleForm1" :rules="rules1" ref="ruleForm1" label-width="100px" class="demo-ruleForm">
                        ...
                        <el-form-item label="密码" prop="pass">
                            <el-input type="password" v-model="ruleForm1.pass" @keyup.native.enter="nameLogin('ruleForm1')"></el-input>
                        </el-form-item>
                        <el-form-item>
                            <el-button type="primary" @click="register">注册</el-button>
                            <el-button type="primary" @click="nameLogin('ruleForm1')">登录</el-button>
                        </el-form-item>
                    </el-form>
                </el-tab-pane>
                <el-tab-pane label="手机号登录" name="手机号登录">
                    <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
                        ...
                        <el-form-item label="密码" prop="pass">
                            <el-input type="password" v-model="ruleForm2.pass" @keyup.native.enter="phoneLogin('ruleForm2')"></el-input>
                        </el-form-item>
                        <el-form-item>
                            <el-button type="primary" @click="register">注册</el-button>
                            <el-button type="primary" @click="phoneLogin('ruleForm2')">登录</el-button>
                        </el-form-item>
                    </el-form>
                </el-tab-pane>
            </el-tabs>
